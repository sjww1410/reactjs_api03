...
import getColumns from './StateColumns';
import Edit from "@material-ui/icons/Edit";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteState, getState} from "../../repo/stateRepo";
/*
...
const StateTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getState(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/state/update/${rowData.state_id}`,
                        user:rowData
                    })
                }
            },
...
export default withRouter(StateTable);
