...
import {deleteCity, getCity} from "../../repo/cityRepo";
/*
...
const CityTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getCity(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/city/update/${rowData.city_id}`,
                        user:rowData
                    })
                }
            },
