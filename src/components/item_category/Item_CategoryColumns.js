 ...
 */
const GetItem_CategoryColumns = (totalCount) => [
  {title: "item_category_id", field: "item_category_id",hidden:true},

  {title: "item_category", field: "item_category"},
...
export default GetItem_CategoryColumns;
