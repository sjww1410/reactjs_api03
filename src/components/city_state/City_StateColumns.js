 ...
 */
const GetCity_StateColumns = (totalCount) => [
  {title: "city_state_id", field: "city_state_id",hidden:true},

  {title: "city_id", field: "city_id"},
{title: "state_id", field: "state_id"},
...
export default GetCity_StateColumns;
