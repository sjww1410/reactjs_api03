 ...
 */
const GetItem_SubcategoryColumns = (totalCount) => [
  {title: "item_subcategory_id", field: "item_subcategory_id",hidden:true},

  {title: "category_id", field: "category_id"},
{title: "item_subcategory", field: "item_subcategory"},
...
export default GetItem_SubcategoryColumns;
