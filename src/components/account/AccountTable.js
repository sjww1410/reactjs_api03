...
import {deleteAccount, getAccount} from "../../repo/accountRepo";
/*
...
const AccountTable = (props) => {
    ...
    const handleRowDelete = (oldData, resolve) => {
        deleteAccount(oldData.account_id)
            .then(res => {
                resolve()
            })
            .catch(error => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getAccount(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/account/update/${rowData.account_id}`,
                        user:rowData
                    })
                }
            },
