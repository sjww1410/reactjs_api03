 ...
 */
const GetAccount_TypeColumns = (totalCount) => [
  {title: "account_type_id", field: "account_type_id",hidden:true},

  {title: "account_type", field: "account_type"},
...
export default GetAccount_TypeColumns;
