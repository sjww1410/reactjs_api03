 ...
 */
const GetCredit_CardColumns = (totalCount) => [
  {title: "credit_card_id", field: "credit_card_id",hidden:true},

  {title: "account_id", field: "account_id"},
{title: "credit_card_number", field: "credit_card_number"},
{title: "credit_card_type", field: "credit_card_type"},
{title: "expiration_date", field: "expiration_date",type:"date"},
{title: "cvv", field: "cvv"},
...
export default GetCredit_CardColumns;
