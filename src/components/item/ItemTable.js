...
import getColumns from './ItemColumns';
import Edit from "@material-ui/icons/Edit";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteItem, getItem} from "../../repo/itemRepo";
/*
...
const ItemTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getItem(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/item/update/${rowData.item_id}`,
                        user:rowData
                    })
                }
            },
