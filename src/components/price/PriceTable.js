...
import getColumns from './PriceColumns';
import Edit from "@material-ui/icons/Edit";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deletePrice, getPrice} from "../../repo/priceRepo";
/*
...
const PriceTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getPrice(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/price/update/${rowData.price_id}`,
                        user:rowData
                    })
                }
            },
